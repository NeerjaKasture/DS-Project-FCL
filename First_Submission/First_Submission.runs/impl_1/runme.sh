...
HD_PWD='C:/Users/mohit/Desktop/DIGITAL SYSTEM/FNN/First_Submission/First_Submission.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_BRAM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UART_BRAM.tcl -notrace
