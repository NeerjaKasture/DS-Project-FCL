...
HD_PWD='C:/Users/mohit/Desktop/DIGITAL SYSTEM/FNN/First_Submission/First_Submission.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_BRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_BRAM.tcl
